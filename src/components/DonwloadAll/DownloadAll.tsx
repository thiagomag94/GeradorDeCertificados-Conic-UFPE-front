...
const DownloadAll = (props:any) => {
  ...
  return (
        <div className='cursor-pointer bg-slate-200 text-blue-900 hover:bg-blue-900 hover:text-slate-50 font-bold flex flex-col px-4 py-4 rounded-lg ' onClick={downloadFiles}>
           Fazer Download
        </div>
