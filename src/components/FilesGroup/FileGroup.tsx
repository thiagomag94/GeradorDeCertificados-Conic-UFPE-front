...
const FilesGroup = (props:any) => {
    ...
    return (
          <div className={` ${alerta==='escolhido' ? '' : 'hidden'} border-2 border-cyan-600/10 flex  justify-center items-center w-full bg-indigo-600/60 text-slate-50 rounded-lg p-4 mt-4`}>
