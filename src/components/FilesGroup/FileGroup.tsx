...
const FilesGroup = (props:any) => {
    ...
    return (
          <div className={` ${alerta==='escolhido' || alerta==='txt escolhido' || alerta==='submitted' ? '' : 'hidden'} border-2 border-cyan-600/10 flex  justify-center items-center w-full bg-blue-600/60 text-slate-50 rounded-lg p-4 mt-4`}>
